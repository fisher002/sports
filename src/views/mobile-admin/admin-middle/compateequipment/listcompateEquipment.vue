    ...
    <van-dialog v-model="showDig" show-cancel-button :showConfirmButton="false">
      <van-form @submit="onSubmit">
        ...
        <van-field name="radio" label="状态" label-align="right">
          <template #input>
            <van-radio-group v-model="sumdata.status" direction="horizontal">
              <van-radio name="no">未退还</van-radio>
              <van-radio name="ing">审核中</van-radio>
              <van-radio name="yes">已退还</van-radio>
            </van-radio-group>
          </template>
        </van-field>
