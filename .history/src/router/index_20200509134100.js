...
import addcompateevent from '@/views/mobile-admin/admin-pregame/compateevent/addcompateevent'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/admin/addcompateevent',
          name: 'addcompateevent',
          meta: {
            label: "比赛项目添加"
          },
          component: addcompateevent
        },
        {
