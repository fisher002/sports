  ...
  <div>
    ...
    <van-dialog v-model="showDig" title="运动员详情" show-cancel-button :showConfirmButton="false">
      <van-form @submit="onSubmit" v-if="students">
        <van-field v-model="students.compateName" label="项目" readonly label-align="right" />
        <van-field v-model="students.studentName" label="名字" readonly label-align="right" />
        <van-field name="radio" label="状态" label-align="right">
          <template #input>
            <van-radio-group v-model="students.studentGroup" direction="horizontal">
              <van-radio name="referee">裁判</van-radio>
              <van-radio name="contestant">运动员</van-radio>
            </van-radio-group>
          </template>
        </van-field>
        <van-field name="radio" label="状态" label-align="right">
