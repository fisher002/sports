  ...
  <div class="game-list">
    <van-pull-refresh v-model="isLoading" success-text="刷新成功" @refresh="onRefresh">
      <div class="drop-menu">
        ...
        <van-search style="width:70%" show-action v-model="params.compateEventName" placeholder="请输入搜索关键词">
          <template #action>
...
export default {
  ...
  methods: {
    ...
    /**onSearch搜索 */
    onSearch(val) {
      console.log(this.checkParams(this.params));
    },
    /**下拉刷新 */
    onRefresh() {
      setTimeout(() => {
