    ...
    <van-tabs v-model="activeName">
      <van-tab title="赛事详情" name="a">
        <van-form>
          ...
          <van-field label="状态" v-html="formatStatus(item.status)" label-align="right" readonly />
          <van-field
            label="性别限制"
            label-align="right"
          ...
          <van-field
            :value="userData.startTime == '' ? '' : formatDate(userData.startTime)"
            label="开始时间"
            label-align="right"
            readonly
          />
          <van-field
            :value="userData.endTime == '' ? '' : formatDate(userData.endTime)"
            label="结束时间"
            label-align="right"
            readonly
          />
