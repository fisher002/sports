...
export default {
    /**返回线上ip */
    returnUrl() {
        const url = 'http://58.248.146.172:9093/';
        return url;
    },
    /**日期格式化v1 */
    formatDates(res) {
    ...
    /**日期格式化v3 */
    formatTime(res) {
        let oldDate = res, nowDate = new Date();
        ...
        if ((nowDate.getTime() / 1000 * 60 - oldDate.getTime() / 1000 * 60) > 5 && (nowDate.getTime() / 1000 * 60 - oldDate.getTime() / 1000 * 60) <= 60) {
            return `${(nowDate.getTime() / 1000 * 60 - oldDate.getTime() / 1000 * 60)}分钟前`;
        }
        if ((nowDate.getTime() / 1000 * 60 - oldDate.getTime() / 1000 * 60) > 60 && (nowDate.getTime() / 1000 * 60 - oldDate.getTime() / 1000 * 60) <= 60 * 10) {
            return `${(nowDate.getTime() / 1000 * 60 * 60 - oldDate.getTime() / 1000 * 60 * 60)}小时前`;
        }
        if ((nowDate.getTime() / 1000 * 60 * 60 - oldDate.getTime() / 1000 * 60 * 60) > 24 && (nowDate.getTime() / 1000 * 60 * 60 - oldDate.getTime() / 1000 * 60 * 60) <= 3 * 24) {
            return `${(nowDate.getTime() / 1000 * 60 * 60 * 24 - oldDate.getTime() / 1000 * 60 * 60 * 24)}天前`;
        }
    },
    /**状态格式化 */
    formatStatus(res) {
